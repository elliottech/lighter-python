...
async with lighter.ApiClient(configuration) as api_client:
    ...
    market_type = 'market_type_example' # str |  (optional)
...
# **trades**
> Trades trades(sort_by, limit, authorization=authorization, market_id=market_id, account_index=account_index, order_index=order_index, sort_dir=sort_dir, cursor=cursor, var_from=var_from, ask_filter=ask_filter, role=role, type=type, aggregate=aggregate)
...
async with lighter.ApiClient(configuration) as api_client:
    ...
    try:
        # trades
        api_response = await api_instance.trades(sort_by, limit, authorization=authorization, market_id=market_id, account_index=account_index, order_index=order_index, sort_dir=sort_dir, cursor=cursor, var_from=var_from, ask_filter=ask_filter, role=role, type=type, aggregate=aggregate)

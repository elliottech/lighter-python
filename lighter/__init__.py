...
from lighter.endpoint_profiles import  (EndpointProfile, MAINNET, ROBINHOOD, TESTNET, ROBINHOOD_TESTNET, DEFAULT_ENDPOINT_PROFILE, ENDPOINT_PROFILES, get_endpoint_profile)

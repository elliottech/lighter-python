...
class AccountApi:
    ...
    async def lit_lease(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="API token authorization")] = None,
        tx_info: Annotated[Optional[StrictStr], Field(description="Signed transaction info (JSON with L2 signature, L1 signature, etc.)")] = None,
        lease_amount: Annotated[Optional[StrictStr], Field(description="Amount of LIT to lease in raw units (1 LIT = 100000000)")] = None,
        duration_days: Annotated[Optional[StrictInt], Field(description="Lease duration in days. Must match one of the available lease options.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param authorization: API token authorization
        :type authorization: str
        :param tx_info: Signed transaction info (JSON with L2 signature, L1 signature, etc.)
        :type tx_info: str
        :param lease_amount: Amount of LIT to lease in raw units (1 LIT = 100000000)
        :type lease_amount: str
        :param duration_days: Lease duration in days. Must match one of the available lease options.
    ...
    async def user_referrals(
        ...
        _param = self._user_referrals_serialize(
            l1_address=l1_address,
            authorization=authorization,
            cursor=cursor,
            auth=auth,
    ...
    @validate_call
    async def user_referrals_with_http_info(
        self,
        l1_address: StrictStr,
        authorization: Optional[StrictStr] = None,
        cursor: Optional[StrictStr] = None,
    ...
    @validate_call
    async def user_referrals_without_preload_content(
        self,
        l1_address: StrictStr,
        authorization: Optional[StrictStr] = None,
        cursor: Optional[StrictStr] = None,

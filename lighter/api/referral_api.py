...
class ReferralApi:
    ...
    @validate_call
    async def referral_has_referee_by_address(
        self,
        ...
        _param = self._referral_has_referee_by_address_serialize(
    ...
    @validate_call
    async def referral_has_referee_by_address_with_http_info(
        self,
        l1_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def referral_has_referee_by_address_without_preload_content(
        self,
        l1_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _referral_has_referee_by_address_serialize(
        self,
        l1_address,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/referral/hasRefereeByAddress',

...
class LivepointsApi:
    ...
    async def live_points_total(
        ...
        _param = self._live_points_total_serialize(
    ...
    async def live_points_total_with_http_info(
        self,
        account_index: StrictInt,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    async def live_points_total_without_preload_content(
        self,
        account_index: StrictInt,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _live_points_total_serialize(
        self,
        account_index,
        authorization,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/livePoints/total',

...
class MarkPriceCandles(BaseModel):
    """
    MarkPriceCandles
    """ # noqa: E501
    code: StrictInt
    ...
    c: List[MarkPriceCandle] = Field(description=" candles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(**{
            ...
            "r": obj.get("r"),
            "c": [MarkPriceCandle.from_dict(_item) for _item in obj["c"]] if obj.get("c") is not None else None
        })
